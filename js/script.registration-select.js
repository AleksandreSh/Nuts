document.addEventListener('DOMContentLoaded', () => {
  ...
  let selectListMas = document.querySelectorAll('.registration__address .select__list .select__item'),
    selectRegion,
    selectRegionMas,
    selectCity,
    selectCityMas;
  ...
  selectList.addEventListener('click', ({ target }) => {
    ...
    selectListMas.forEach(elem => {
      elem.classList.contains('select__item_active') ? elem.classList.remove('select__item_active') : null;
    });
    target.classList.add('select__item_active');
    selectList.classList.toggle('select__list_show');
    selectRegion = document.querySelector(`.select__list_${address.country}`);
    selectRegionMas = document.querySelectorAll(`.select__list_${address.country} .select__item`);
  ...
  selectListFop.addEventListener('click', ({ target }) => {
    ...
    selectListMasFop.forEach(elem => {
      elem.classList.contains('select__fop-item_active') ? elem.classList.remove('select__fop-item_active') : null;
    });
    target.classList.add('select__fop-item_active');
    selectListFop.classList.toggle('select__fop-list_show');
    selectRegionFop = document.querySelector(`.select__fop-list_${addressFop.country}`);
    selectRegionMasFop = document.querySelectorAll(`.select__fop-list_${addressFop.country} .select__item`);
  ...
  selectListCorp.addEventListener('click', ({ target }) => {
    ...
    selectRegionMasCorp = document.querySelectorAll(`.select__corporate-list_${addressCorp.country} .select__item`);
    ...
    selectRegionCorp.addEventListener('click', ({ target }) => {
      ...
      selectCityCorp = document.querySelector(`.select__corporate-list_${region[`${addressCorp.region}`]}`);
