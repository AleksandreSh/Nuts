document.addEventListener('DOMContentLoaded', () => {
  ...
  let selectListFopMas = document.querySelectorAll('.address__country .select__list .select__item'),
    selectRegionFop,
    selectRegionFopMas;
  ...
  selectListFop.addEventListener('click', ({ target }) => {
    ...
    selectRegionFopMas = document.querySelectorAll(`.select__list_${address.country} .select__item`);
  ...
  selectListCorp.addEventListener('click', ({ target }) => {
    ...
    target.classList.add('select__item_active');
    selectListCorp.classList.toggle('select__list_show');
    selectRegionCorp = document.querySelector(`.select__head-corp ~ .select__list_${addressCorp.country}`);
    selectRegionMasCorp = document.querySelectorAll(`.select__list_${addressCorp.country} .select__item`);
  ...
  selectListLegal.addEventListener('click', ({ target }) => {
    ...
    target.classList.add('select__item_active');
    selectListLegal.classList.toggle('select__list_show');
    selectRegionLegal = document.querySelector(`.select__head-legal ~ .select__list_${addressLegal.country}`);
    console.log(selectRegionLegal);
    selectRegionMasLegal = document.querySelectorAll(`.select__list_${addressLegal.country} .select__item`);
