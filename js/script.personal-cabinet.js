document.addEventListener('DOMContentLoaded', () => {
  ...
  const addActiveClassToTab = i => {
    tabs.forEach(elem => {
      elem.classList.contains('content__tab_active') ? elem.classList.remove('content__tab_active') : null;
    });
  ...
  const addActiveClassToItem = target => {
    listItem.forEach(elem => {
      elem.classList.contains('content__item_active') ? elem.classList.remove('content__item_active') : null;
    });
